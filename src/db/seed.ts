...
async function main() {
  ...
  try {
    ...
    // 3. Seed Services with dynamic layout metadata and pricing configurations
    console.log("Inserting services with pricing arrays...");
    await db.insert(services).values([
      {
        title: "Workplace Wellness Bootcamps",
        subtitle: "Corporate Training Intensives",
        description: "Transformative training intensives focused on shifting organizational energy. Built across three pillars: Leadership (equipping managers to recognize burnout indicators), Transformation (rewiring personal resilience frameworks), and Culture (aligning corporate habits with human empathy). The ultimate focus is breaking down what drives your workforce—because when leaders understand what makes an employee tick, engagement skyrockets.",
      ...
      },
      {
        ...
        subtitle: "Direct Support & Counseling",
        description: "Dedicated, clinical-grade professional coaching designed exclusively for employees. These personalized sessions give your team a safe, confidential sandbox to process workplace stressors, discover personal career drivers, and unpack anxiety, leading to sustained clarity and output on the job.",
